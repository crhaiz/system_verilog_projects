...
HD_PWD='C:/Users/cherr/ECE385_Lab4/ECE385_Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevelmultiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevelmultiplier.tcl
