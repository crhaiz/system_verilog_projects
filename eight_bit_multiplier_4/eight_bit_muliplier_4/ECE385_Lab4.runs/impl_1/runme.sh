...
HD_PWD='C:/Users/cherr/ECE385_Lab4/ECE385_Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevelmultiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source toplevelmultiplier.tcl -notrace
