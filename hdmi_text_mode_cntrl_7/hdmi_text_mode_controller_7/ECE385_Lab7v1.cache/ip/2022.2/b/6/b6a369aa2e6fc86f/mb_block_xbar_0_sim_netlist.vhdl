...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[0]_INST_0\ : label is "soft_lutpair28";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[17]_INST_0\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[1]_INST_0\ : label is "soft_lutpair28";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[22]_INST_0\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[26]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \m_axi_wdata[27]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \m_axi_wdata[28]_INST_0\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[30]_INST_0\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \m_axi_wstrb[2]_INST_0\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \s_axi_awready[1]_INST_0\ : label is "soft_lutpair4";
...
\m_atarget_enc[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
        ...
        port map (
      I0 => \^target_mi_enc\(0),
      I1 => \^gen_arbiter.m_amesg_i_reg[19]_0\,
      O => any_error
    );
...
\m_atarget_hot[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \^target_mi_enc\(0),
      I1 => p_0_in,
      I2 => \^gen_arbiter.m_amesg_i_reg[19]_0\,
      O => D(2)
    );
...
m_valid_i_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => aa_grant_enc,
      I3 => s_axi_rready(0),
      I4 => \^gen_arbiter.grant_rnw_reg_4\,
      I5 => m_ready_d_0(0),
      O => m_valid_i_i_3_n_0
    );
...
addr_arbiter_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_addr_arbiter_sasd
     port map (
      ...
      \gen_arbiter.grant_rnw_reg_1\ => addr_arbiter_inst_n_4,
      \gen_arbiter.grant_rnw_reg_2\ => addr_arbiter_inst_n_7,
      \gen_arbiter.grant_rnw_reg_3\ => addr_arbiter_inst_n_59,
      \gen_arbiter.grant_rnw_reg_4\ => addr_arbiter_inst_n_65,
      ...
      \m_atarget_hot_reg[3]_0\ => addr_arbiter_inst_n_110,
      ...
      \s_axi_bready[0]_0\ => addr_arbiter_inst_n_5,
...
\gen_decerr.decerr_slave_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_decerr_slave
     port map (
      ...
      aclk => aclk,
      aresetn_d => aresetn_d,
      \gen_arbiter.m_grant_hot_i_reg[1]\ => addr_arbiter_inst_n_2,
      ...
      \m_ready_d_reg[0]_0\(1 downto 0) => m_atarget_enc(1 downto 0),
      mi_bvalid(0) => mi_bvalid(3),
      mi_wready(0) => mi_wready(3)
    );
...
splitter_ar: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_crossbar_v2_1_28_splitter__parameterized0\
     port map (
      aclk => aclk,
      \gen_arbiter.m_grant_hot_i_reg[1]\ => addr_arbiter_inst_n_66,
