...
HD_PWD='C:/Users/cherr/ECE385_Lab7v1/ECE385_Lab7v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_toplevel.tcl
