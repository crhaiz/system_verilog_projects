...
HD_PWD='C:/Users/cherr/ECE385_Lab7v1/ECE385_Lab7v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_toplevel.tcl -notrace
